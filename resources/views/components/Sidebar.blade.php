<head>
    ...
    <div>
        <aside id="default-sidebar" class="shadow-lg fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 px-3  bg-[#f8f9fa]" aria-label="Sidebar">  
        ...
        <ul class="mt-1">
            ...
            <li>
                <a href="{{route('myQueues')}}" class="group flex items-center px-4 py-3 text-sm text-black rounded hover:bg-[#e5ffc2] hover:text-green-900 transform hover:transition-all duration-700 ease-in-out">
                    ...
                    <span class="group-hover:-translate-x-[-7px] transition-all duration-700 ease-in-out">My Assigned Queues and Windows</span>
                </a>
            </li>
